...
public class LoginPage extends WebElements {
    ...
    public void insertIncorrectUsername(){sendKeysFunction(subjectUsername, incorrectUsername);       }

    @FindBy(name = "password")
    private WebElement subjectPassword;
    public void insertPassword () { sendKeysFunction(subjectPassword, correctPassword);}
    ...
    public void clickLoginButton(){clickFunction(LoginButton);}
